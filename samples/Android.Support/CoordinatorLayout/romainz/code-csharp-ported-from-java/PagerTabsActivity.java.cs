...
// mc++  */
// mc++ public class PagerTabsActivity extends AppCompatActivity implements View.OnClickListener {
// mc++ 
// mc++     public static void start(Context context) {
// mc++         Intent intent = new Intent(context, PagerTabsActivity.class);
...
// mc++         setContentView(R.layout.activity_pager_tabs);
// mc++ 
