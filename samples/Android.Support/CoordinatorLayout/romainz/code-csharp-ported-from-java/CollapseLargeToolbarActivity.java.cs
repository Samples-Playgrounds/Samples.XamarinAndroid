...
// mc++  */
// mc++ public class CollapseLargeToolbarActivity extends AppCompatActivity {
// mc++ 
// mc++     public static void start(Context context) {
// mc++         Intent intent = new Intent(context, CollapseLargeToolbarActivity.class);
...
// mc++         setContentView(R.layout.activity_collapse_large_toolbar);
// mc++ 
...
// mc++ 
// mc++         String toolbarTitle = getResources().getString(R.string.sample_collapse_toolbar);
