...
// mc++ import com.example.zcp.coordinatorlayoutdemo.ui.SnackbarUtil;
...
// mc++ 
// mc++ public class BottomSheetActivity extends AppCompatActivity implements GridAdapter.OnRecyclerViewItemClickListener {
// mc++ 
...
// mc++ 
// mc++         StatusBarUtil.setStatusBarColor(BottomSheetActivity.this,R.color.colorPrimaryDark);//设置状态栏颜色
// mc++ 
// mc++         initView();
// mc++         setListener();
// mc++ 
...
// mc++                     mAdapter.setOnItemClickListener(BottomSheetActivity.this);//底栏折叠状态下恢复RecyclerView item的点击
// mc++                 }
// mc++             }
// mc++             @Override
...
// mc++ 
// mc++         SnackbarUtil.ShortSnackbar(coordinatorLayout,"点击第"+position+"个",SnackbarUtil.Info).show();
// mc++ 
// mc++         Picasso.with(BottomSheetActivity.this).load(meizis.get(position).getUrl()).into(bottom_sheet_iv);
// mc++     }
// mc++ 
// mc++     @Override
...
// mc++                     meizis.add(pages);
// mc++ 
// mc++                     Picasso.with(BottomSheetActivity.this).load(meizis.get(0).getUrl()).into(bottom_sheet_iv);
// mc++                 }else{
...
// mc++ 
// mc++                 if(mAdapter==null){
// mc++                     recyclerview.setAdapter(mAdapter = new GridAdapter(BottomSheetActivity.this,meizis));
// mc++                     mAdapter.setOnItemClickListener(BottomSheetActivity.this);
// mc++ 
// mc++                 }else{
