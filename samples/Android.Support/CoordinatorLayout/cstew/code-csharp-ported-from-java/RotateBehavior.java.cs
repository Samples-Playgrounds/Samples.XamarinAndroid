...
// mc++ 
// mc++ public class RotateBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
// mc++     private static final String TAG = ShrinkBehavior.class.getSimpleName();
// mc++ 
// mc++     public RotateBehavior() {
// mc++     }
// mc++ 
// mc++     public RotateBehavior(Context context, AttributeSet attrs) {
...
// mc++         child.setRotation(-90 * percentComplete);
