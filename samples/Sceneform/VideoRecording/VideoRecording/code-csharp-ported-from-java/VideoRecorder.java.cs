...
// mc++ 
// mc++   private static final int[] FALLBACK_QUALITY_LEVELS = {
// mc++     CamcorderProfile.QUALITY_HIGH,
// mc++     CamcorderProfile.QUALITY_2160P,
// mc++     CamcorderProfile.QUALITY_1080P,
// mc++     CamcorderProfile.QUALITY_720P,
// mc++     CamcorderProfile.QUALITY_480P
// mc++   };
// mc++ 
...
// mc++     CamcorderProfile profile = null;
// mc++     if (CamcorderProfile.hasProfile(quality)) {
// mc++       profile = CamcorderProfile.get(quality);
// mc++     }
// mc++     if (profile == null) {
// mc++       // Select a quality  that is available on this device.
// mc++       for (int level : FALLBACK_QUALITY_LEVELS) {
// mc++         if (CamcorderProfile.hasProfile(level)) {
// mc++           profile = CamcorderProfile.get(level);
// mc++           break;
// mc++         }
// mc++       }
// mc++     }
